...
-(instancetype)initWithFrame:(CGRect)frame numberOfStars:(NSInteger)numberOfStars rateStyle:(StarStyle)rateStyle isAnination:(BOOL)isAnimation andamptyImageName:(NSString *)amptyImageName fullImageName:(NSString *)fullImageName finish:(finishBlock)finish{
